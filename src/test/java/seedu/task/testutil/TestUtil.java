...
public class TestUtil {
    ...
    private static Task[] getSamplePersonData() {
        try {
            ...
            return new Task[]{
                new Task(new Description("Ali Muster"), null, null, new UniqueTagList(), null),
                new Task(new Description("Boris Mueller"), null, null, new UniqueTagList(), null),
                new Task(new Description("Carl Kurz"), null, null, new UniqueTagList(), null),
                new Task(new Description("Daniel Meier"), null, null, new UniqueTagList(), null),
                new Task(new Description("Elle Meyer"), null, null, new UniqueTagList(), null),
                new Task(new Description("Fiona Kunz"), null, null, new UniqueTagList(), null),
                new Task(new Description("George Best"), null, null, new UniqueTagList(), null),
                new Task(new Description("Hoon Meier"), null, null, new UniqueTagList(), null),
                new Task(new Description("Ida Mueller"), null, null, new UniqueTagList(), null)
            };
